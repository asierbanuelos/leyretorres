...
<nav class="leyre-navbar">
    ...
    <ul class="leyre-navbar__nav" id="leyre-nav">
        <li><a href="<?php echo home_url( '/area-privada' ); ?>"   class="<?php echo is_page('area-privada')   ? 'active' : ''; ?>">Mi programa</a></li>
        <li><a href="<?php echo home_url( '/mis-cursos' ); ?>"     class="<?php echo is_page('mis-cursos')     ? 'active' : ''; ?>">Mis cursos</a></li>
        <li><a href="<?php echo home_url( '/recursos' ); ?>"       class="<?php echo is_page('recursos')       ? 'active' : ''; ?>">Recursos</a></li>
        <li><a href="<?php echo home_url( '/mis-sesiones' ); ?>"   class="<?php echo is_page('mis-sesiones')   ? 'active' : ''; ?>">Mis sesiones</a></li>
    </ul>
